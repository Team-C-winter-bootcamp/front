      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex gap-6 text-sm font-medium text-slate-600">
            <a href="#" className="hover:text-indigo-600 transition">서비스 소개</a>
            <a href="#" className="hover:text-indigo-600 transition">기능 가이드</a>
            <a href="#" className="hover:text-indigo-600 transition">요금제</a>
            <a href="#" className="hover:text-indigo-600 transition">고객지원</a>
          </div>
        </div>
