          ...
          <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-slate-500 leading-relaxed mb-12 max-w-3xl mx-auto font-medium">
                ...
                LAWDING AI가 당신의 상황을 6만 건의 판례데이터를 기반으로로 정밀 진단하고 <span className="text-slate-900 font-bold underline underline-offset-4 decoration-indigo-200">최적의 법적 대응책</span>을 제시합니다.
              </p>
